#
#  Be sure to run `pod spec lint EKPrivateLib.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "king" => "peng.jin@haihangyun.com" }
  # Or just: s.author    = "king"
  # s.authors            = { "king" => "peng.jin@haihangyun.com" }
  # s.social_media_url   = "http://twitter.com/king"
